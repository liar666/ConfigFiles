...
firefoxbox.image = image("/usr/lib/firefox/chrome/icons/default/default32.png")
...
eclipsebox:buttons(awful.util.table.join(awful.button({ }, 1, function () awful.util.spawn("/home/guillaume/eclipse/eclipse") end)))
